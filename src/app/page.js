...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-700 relative overflow-hidden">
      {/* Animated floating elements */}
      <div className="absolute top-16 -left-12 w-40 h-40 rounded-full bg-red-100 opacity-40 blur-3xl animate-float-slow"></div>
      <div className="absolute bottom-24 -right-16 w-56 h-56 rounded-full bg-green-100 opacity-30 blur-3xl animate-float"></div>
      <div className="absolute top-1/3 right-1/4 w-20 h-20 rounded-full bg-blue-100 opacity-25 animate-bounce-slow"></div>
      <div className="absolute bottom-1/3 left-1/4 w-12 h-12 rounded-full bg-amber-100 opacity-35 animate-pulse"></div>

      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        {/* Hero Section */}
        <div className="text-center max-w-4xl mx-auto mb-24">
          <div className="inline-block mb-6">
            <span className="px-4 py-1.5 bg-amber-100 text-amber-600 rounded-full text-sm font-medium border border-amber-200">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold leading-tight mb-6">
            ...
            <span className="block mt-3 text-gray-600 text-xl md:text-2xl font-normal">
              Untukmu yang ingin <span className="text-green-500">teratur</span>, tapi tetap <span className="text-blue-500">bebas</span>.
            </span>
          </h1>

          <p className="text-base md:text-lg text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link
              href="#fitur"
              className="px-7 py-3.5 rounded-full bg-white text-gray-600 font-medium border border-gray-200 hover:bg-gray-50 hover:shadow-sm transition-all"
            >
              Jelajahi Fitur →
            </Link>
          </div>
        ...
        {/* Closing CTA */}
        <div className="text-center max-w-3xl mx-auto bg-white p-7 rounded-2xl border border-gray-100 shadow-sm">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3">
            Ruang kecil untuk <span className="text-green-500">hidup besar</span> milikmu.
          </h3>
