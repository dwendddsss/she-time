  ...
  return (
    <header className="relative px-4 py-10 text-center overflow-hidden hidden md:block">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-4 relative z-10">
        <span className="bg-clip text-pink-500">
          SheTime ✨
        </span>
      </h1>

      <p className="max-w-lg mx-auto mb-10 px-15 text-sm md:text-base text-gray-700">
      <span className="text-blue-600">Rencanakan lebih cerdas | Bekerja lebih efisien  Hidup lebih bahagia</span>
      </p>
